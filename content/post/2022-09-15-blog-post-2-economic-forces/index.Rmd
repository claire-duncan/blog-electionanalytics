...
## year of midterm race, ONLY FOR OCTOBER
```{r, include = FALSE}
...
dataOCT2%>%
  ggplot(aes(x=percent, y=D_majorvote_pct,
    ...
    theme_bw() +
    labs(title = "October Unemployment Percentage and Democratic Vote Share in House Elections", subtitle = "midterm years between 1978-2018")
...
## MODEL FOR OCT ONLY, D INCUMBENT
```{r, include = FALSE, show_col_types = FALSE}
