...
The adjusted R^2 for my model was 0.721, indicating that it has relatively strong predictive power. The variables can explain 72.1% of the variability in the prediction model
...
Another important limitation to note is the wide interval of my prediction - Democrats winning between 171 to 239 seats means significantly different results across the board for this election. The wide interval for both seat share and vote share may be due to the more limited dataset, or the subset of midterm election years I used.
...
Below, find my graph of each Congressional district and the predicted Democratic vote share. Note that the scale is from 30%-70%, as I wanted to make the differences in vote share more easily perceivable.
