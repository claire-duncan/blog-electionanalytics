...
categories: []
tags: []
summary: In this reflection on the Congressional race in New York's 18th District, I will analyze why the results slightly deviated from the forecasts and compare it to similar races in the state.
...
The three top priorities Ryan’s website promotes are: Leveling the Playing Field, Protecting our Foundational Freedoms, and Keeping our Community Safe. While the “Leveling the Playing Field” priority does touch on the economy, the other two would be cited as Vavreck as good for an insurgent campaign, the type that Ryan’s would be categorized as - given his status as an incumbent (at least in the sense of party control of the district) and the bad status of the economy. Ryan focused his campaign during the special election on abortion access, which Vavreck would approve of. He also focused his campaign for the general election broadly on protecting basic freedoms in the United States, capitalizing on promoting the fight for democracy.
