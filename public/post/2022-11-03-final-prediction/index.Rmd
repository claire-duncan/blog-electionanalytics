...
categories: []
tags: []
summary: The 2022 midterm election is only ONE day away! It’s time for my final prediction for the House of Representatives.
---
...
outsamp_dflist <- lapply(all_years, function(year){
  ...
  mod_plus_D_ <- lm(DemVotesMajorPercent ~ pres_approval + demincumb + avg_rating + Unemployed_prct, data = dist2)
  mod_plus_R_ <- lm(RepVotesMajorPercent ~ pres_approval + demincumb + avg_rating +  + Unemployed_prct, data = dist2)
...
colMeans(abs(outsamp_df[1:3]), na.rm=T)
